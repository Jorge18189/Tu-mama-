...
<style>
    .card-link {
        ...
        display: block; /* Asegura que el enlace abarque todo el contenido */
    }
</style>
    ...
    <h2 class="section-title">Informate!</h2>
    <div class="grid-container">
      <!-- Card 1 -->
<div class="card" onclick="window.location.href='programas.php'">
    <button class="info-button" onclick="event.stopPropagation();">i</button>
    ...
    <div class="info-content">
        Explora la variedad de carreras y programas que se ofertan
    </div>
</div>
        ...
        <!-- Card 2 -->
<div class="card" onclick="window.location.href='becas.php'">
    <button class="info-button" onclick="event.stopPropagation();">i</button>
    ...
    <div class="info-content">
        ...
        <!-- Card 3 -->
        <div class="card" onclick="window.location.href='../materiales/materiales.php'">
    <button class="info-button" onclick="event.stopPropagation();">i</button>
    ...
    <div class="info-content">
       ...
       <!-- Card 4 -->
<div class="card" onclick="window.location.href='calendario.php'">
    <button class="info-button" onclick="event.stopPropagation();">i</button>
    ...
    <div class="info-content">
      ...
      <!-- Card 5 -->
<div class="card" onclick="window.location.href='internacional.php'">
    <button class="info-button" onclick="event.stopPropagation();">i</button>
    ...
    <div class="info-content">
        ...
        <!-- Card 6 -->
<div class="card" onclick="window.location.href='../mensajes/mensajes.php'">
    <button class="info-button" onclick="event.stopPropagation();">i</button>
    ...
    <div class="info-content">
        ...
        <!-- Card 7 -->
<div class="card" onclick="window.location.href='../proceso/progreso.php'">
    <button class="info-button" onclick="event.stopPropagation();">i</button>
    ...
    <div class="info-content">
        Información sobre reconocimientos y tu progreso
    </div>
</div>


       <!-- Card 8 -->
<div class="card" onclick="window.location.href='../bienestar/bienestar.php'">
    <button class="info-button" onclick="event.stopPropagation();">i</button>
    ...
    <div class="info-content">
       ...
       <!-- Card 9 -->
<div class="card" onclick="window.location.href='../serviciosuni/serviciosuni.php'">
    <button class="info-button" onclick="event.stopPropagation();">i</button>
