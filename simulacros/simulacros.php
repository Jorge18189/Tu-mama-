...
<body>
<h1 class="title">Simulacros</h1>    
    <div class="grid-container">
        <div class="card">
            <img src="../imagenes/ipn.jpg" class="card-image">
            <div class="card-content">Instituto Politecnico Nacional</div>
        </div>
        
        <div class="card">
            <img src="../imagenes/unam.png" class="card-image">
            <div class="card-content">Universidad Nacional Autonoma de Mexico</div>
        </div>
    </div>
</body>
</html>
