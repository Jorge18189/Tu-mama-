...
$palabras_pistas = file('matematicasb.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
...
if (isset($_GET['reset'])) {
    ...
    header("Location: matematicasb.php");
    exit;
}
?>
...
<body>
<h1 class="title">
<a href="../juegos.php">Juegos</a> > <a href="categorias.php">Ahorcado</a> > Matematicas Basicas
</h1>
<div class="ahorcado">
        <?php
