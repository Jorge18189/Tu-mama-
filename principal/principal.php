...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="../inicio/inicio.php" target="contentFrame"><i class="fas fa-home"></i><span>INICIO</span></a>
        ...
        <a href="../proceso/progreso.php" target="contentFrame"><i class="fas fa-chart-line"></i><span>PROGRESO</span></a>
    </div>
    ...
    <div class="main-content">
        <iframe name="contentFrame" src="../inicio/inicio.php"></iframe>
    </div>
